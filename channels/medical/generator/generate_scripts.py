...
- thumbnail_image_query: サムネイル背景に使うライセンス確認済み写真を検索するための短い英語キーワード（2〜4語、例:"capsule medicine", "CT scanner", "laboratory microscope"）。話題の対象が一目で分かる具体的な剤形、医療機器、臓器模型、顕微鏡像を優先し、患者を特定できる写真、製品広告、抽象的すぎる医療イメージは避ける。
