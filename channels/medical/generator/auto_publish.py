...
def main():
    if os.getenv("ENABLE_AUTO_PUBLISH", "0") != "1":
        print("[info] auto publish disabled; set ENABLE_AUTO_PUBLISH=1 after reviewing private uploads")
        return
    ...
    video_ids = [data["long"], *data["shorts"]]
