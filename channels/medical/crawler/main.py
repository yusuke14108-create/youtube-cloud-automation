...
from crawler.sites import mhlw, niid, pmda, pubmed
...
SITES = [pmda, mhlw, niid, pubmed]


def main():
    session = requests.Session()
    session.headers.update({"User-Agent": "Mozilla/5.0 (compatible; medical-news-bot/1.0)"})
