...
SELECT_PROMPT_TEMPLATE = """以下は日本人選手を軸にしつつ、NBA全体も含めた本日のニュース候補です。

日本人選手を中心にNBAを解説するYouTubeチャンネルの長尺動画として、重複しないテーマを最大{max_topics}件選んでください。日本人以外でも、大型契約、移籍、記録、プレーオフなど日本の視聴者が強く関心を持ちそうな話題は採用できます。
...
- 原則は日本人選手を優先。ただし注目度と検証可能性が明確に高いリーグ全体の話題を最大1件採用してよい
